...
int main(int argc, char *argv[])
{
    ...
    if (!setup_logger(LOGGING_PATH_TRACE, LOG_TRACE, true) || !setup_logger(LOGGING_PATH_INFO, LOG_INFO, false) || !setup_logger(LOGGING_PATH_FATAL, LOG_FATAL, false)) // trace does print to STDOUT, info does
    {
        return 1;
    }
